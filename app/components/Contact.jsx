...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="w-full px-6 sm:px-[10%] md:px-[12%] py-10 scroll-mt-20 bg-[url('/footer-bg-color.png')] bg-no-repeat bg-center bg-[length:90%_auto]"
    >
      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
        ...
        <textarea
          ...
          required
          className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-4" name="message"
        ></textarea>
